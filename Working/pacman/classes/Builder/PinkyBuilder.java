...
public class PinkyBuilder {
	...
	public Pinky startFastPinky() {
		return new PinkyConfigurator(new FastPinky()).addX(96).addY(96).addDx(-1).addDy(0).addSpeed(4).addColor(pinkColor).addFrightened(Boolean.FALSE).addStrategy(new PinkyAlgorithm()).build();
	}
	
	public Pinky startSlowPinky() {
		return new PinkyConfigurator(new SlowPinky()).addX(96).addY(96).addDx(-1).addDy(0).addSpeed(2).addColor(pinkColor).addFrightened(Boolean.FALSE).addStrategy(new PinkyAlgorithm()).build();
	}
}
