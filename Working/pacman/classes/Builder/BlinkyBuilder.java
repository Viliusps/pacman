...
public class BlinkyBuilder {
	...
	public Blinky startFastBlinky() {
		return new BlinkyConfigurator(new FastBlinky(new RedColor())).addX(96).addY(96).addDx(1).addDy(0).addSpeed(4).addColor().addFrightened(Boolean.FALSE).addStrategy(new BlinkyAlgorithm()).build();
	}
	
	public Blinky startSlowBlinky() {
		return new BlinkyConfigurator(new SlowBlinky(new RedColor())).addX(96).addY(96).addDx(1).addDy(0).addSpeed(2).addColor().addFrightened(Boolean.FALSE).addStrategy(new BlinkyAlgorithm()).build();
	}
}
