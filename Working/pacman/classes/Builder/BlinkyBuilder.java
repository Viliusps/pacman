...
public class BlinkyBuilder {
	...
	public Blinky startFastBlinky() {
		return new BlinkyConfigurator(new FastBlinky()).addX(96).addY(96).addDx(1).addDy(0).addSpeed(4).addColor(redColor).addFrightened(Boolean.FALSE).addStrategy(new BlinkyAlgorithm()).build();
	}
	
	public Blinky startSlowBlinky() {
		return new BlinkyConfigurator(new SlowBlinky()).addX(96).addY(96).addDx(1).addDy(0).addSpeed(2).addColor(redColor).addFrightened(Boolean.FALSE).addStrategy(new BlinkyAlgorithm()).build();
	}
}
