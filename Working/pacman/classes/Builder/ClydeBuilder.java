...
public class ClydeBuilder {
	...
	public Clyde startFastClyde() {
		return new ClydeConfigurator(new FastClyde()).addX(96).addY(96).addDx(1).addDy(0).addSpeed(4).addColor(orangeColor).addFrightened(Boolean.FALSE).build();
	}
	
	public Clyde startSlowClyde() {
		return new ClydeConfigurator(new SlowClyde()).addX(96).addY(96).addDx(1).addDy(0).addSpeed(2).addColor(orangeColor).addFrightened(Boolean.FALSE).build();
	}
}
